...
const steps = [
  {
    ...
    model: "Sonnet 4.5",
    description:
      "Converse naturalmente com nosso agente Navigator. Ele entende seu contexto, problema e objetivos sem formularios rigidos.",
    ...
    <section className="relative py-24">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6">
        ...
        >
          <motion.p
            variants={slideUp}
            className="mb-3 font-mono text-xs uppercase tracking-[0.25em] text-sage"
          >
            Pipeline
          </motion.p>
          <motion.h2
          ...
          >
            Cada etapa usa um modelo Claude especializado. Voce acompanha
